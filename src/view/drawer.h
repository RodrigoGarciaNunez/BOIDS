...
public:
    ...
    map<shared_ptr<Object>, bool> bodies_to_draw; //este funciona para saber si el cuerpo se debe actualizar o sólo se imprime como está para el siguiente frame
